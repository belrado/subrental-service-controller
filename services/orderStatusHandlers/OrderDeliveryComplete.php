 ...
 * 매일 00:01 크론 처리
 */
class OrderDeliveryComplete extends OrderStatusHandlerAbstract
{
    ...
    public function handle($od_id, array $params, bool $useTransaction): array
    {
        ...
        return $this->processOrderUpdate(
            ...
            function ($orderStatusModel, $od_id, $params) {
                ...
                if ($orderStatusModel->updateOrderDeliveryComplete($params['date'])) {
                    return true;
                } else {
                    throw new CustomException("주문 상태값 변경 (택배 - 배송완료) 실패", '0009', [
                        'od_id' => $od_id
                    ]);
                }
            }
